...
Route::group(['prefix' => 'sepet'],function (){
    Route::get('/',[\App\Http\Controllers\basketController::class,'index'])->name('baskett');
    Route::post('/ekle',[\App\Http\Controllers\basketController::class,'addd'])->name('baskett.addd');
});
...
Route::group(['prefix'=>'kullanici'], function(){
    ...
    Route::post('/oturumukapat',[\App\Http\Controllers\userController::class,'logoutFunc'])->name('user.logoutFunc');
});
