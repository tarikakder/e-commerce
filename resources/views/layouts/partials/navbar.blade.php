    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <li><a href="{{route('user.register')}}">Üye Ol</a></li>
                @endguest
                @auth
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a onclick="event.preventDefault(); document.getElementById('logout-form').submit();" href="#">Çıkış</a>
                        <form id="logout-form" action="{{route('user.logoutFunc')}}}" method="post" style="display:none;">
{{csrf_field()}}                        </form>
